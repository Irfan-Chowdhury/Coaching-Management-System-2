                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('class_name') is-invalid @enderror" name="class_name" value="{{ $class->class_name }}" id="slideTitle" placeholder="Write Class Name here" required>
                                            @error('class_name')
